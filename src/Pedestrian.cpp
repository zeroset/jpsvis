...
void Pedestrian::CreateActor3D()
{
...

    {
        ...
        // cout << "diffuse: "<<actor->GetProperty()->GetDiffuse()<<" [" <<
        // actor->GetProperty()->GetDiffuseMinValue()<<" ,
        // "<<actor->GetProperty()->GetDiffuseMaxValue() << " ]"<<endl; cout << "ambiant:
        // "<<actor->GetProperty()->GetAmbient()<<" [" <<
        // actor->GetProperty()->GetAmbientMinValue()<<" ,
        // "<<actor->GetProperty()->GetAmbientMaxValue() << " ]"<<endl; cout <<
        // "specular:"<<actor->GetProperty()->GetSpecular()<<" [" <<
        // actor->GetProperty()->GetSpecularMinValue()<<" ,
        // "<<actor->GetProperty()->GetSpecularMaxValue()<< " ]"<<endl;
...

    {
...

        {
...

            {
                ...
                actor->SetPosition(
                    radius * cos(-pi_over_4), radius * sin(-pi_over_4), headCenter[2]);
